...
int main()
{
    ...
    */
    ...
    // These modification functions could be chained together
    mat16.AddRow({1, 2, 3, 4}).AddColumn({4, 3, 2, 1, 0});
    VX(mat16);
    /*
    mat16
        -1    -1    -1    -1    4
    ...
    */
    ...
    // Extract a block of elements from the matrix
